package com.yusufguler.simplecalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void sum(View view )
    {
        ...
        {
        resultText.setText("enter nubmer");
        }
        else
        {
            int number1 =Integer.parseInt(numberText2.getText().toString());
            int number2 = Integer.parseInt(numberText1.getText().toString());
